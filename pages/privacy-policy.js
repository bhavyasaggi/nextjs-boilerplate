...
export default function PrivacyPolicy() {
  return (
    <Container className='mt-3 mb-3 text-justify'>
      <h1 className='mt-5 mb-5 fw-bold text-primary text-center'>
        Privacy Policy for ________
      </h1>
      <p>
        At ________, accessible from{' '}
        <a href='https://________.com'>https://________.com</a>, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by ________
        and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in ________. This policy is not applicable to any
        information collected offline or via channels other than this website.
      </p>
      <h2 className='mt-5 mb-3 fw-bold text-primary text-center'>Consent</h2>
      <p>
        By using our website, you hereby consent to our Privacy Policy and agree
        to its terms.
      </p>
      <h2 className='mt-5 mb-3 fw-bold text-primary text-center'>
      ...
      <p>
        Like any other website, ________ uses &lsquo;cookies&rsquo;. These
      ...
      <p>
        ...
        advertising partners of ________.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on ________, which are sent
      ...
      <p>
        Note that ________ has no access to or control over these cookies that
      ...
      <p>
        ________&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        ________ does not knowingly collect any Personal Identifiable
